...
const AboutUs = () => {
    return (
        <section className="bg-gray-50 dark:bg-medium dark:text-white py-16 px-6 md:px-12 lg:px-20">
            <div className=" mx-auto text-center">
                ...
                <div className="space-y-8  md:flex-row items-center gap-8">
                    ...
                    <div className="flex-1 dark:text-white">
                        <p className="text-xl dark:text-white font-semibold text-gray-600">
                        ...
                        <p className="mt-4 dark:text-white text-xl font-semibold text-gray-600">
